...
public class HomeAddress extends AddressId implements Address<HomeAddress>  {
    ...
    public HomeAddress(String city, String district, String street, String detailAddress) {
        this.city = city;
    ...
    public void showAddressInfo() {
        ...
        System.out.println("Id : "+this.getAddressId()+ " - İl : " +this.getCity()+ ", İlçe : " +this.getDistrict()+", Sokak : " +this.getStreet());
